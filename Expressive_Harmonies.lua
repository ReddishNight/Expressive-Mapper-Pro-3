--[[
===============================================================================
  Expressive Harmonies - Synthesizer V Studio Pro 2 Panel
  Autor: Nyoru.X
...
local function asegurarWidgetsPanel3(cfg)
    ...
    if not panelWidgets then
        panelWidgets = {
            ...
            modoArmonia = SV:create("WidgetValue"),
            presetCoral = SV:create("WidgetValue"),
            antiFaseMs = SV:create("WidgetValue"),
            antiFaseCents = SV:create("WidgetValue"),
            armoniaIntervalosCustom = SV:create("WidgetValue"),
            enableJustIntonation = SV:create("WidgetValue"),
...
function getSidePanelSectionState()
    ...
    local widgets = asegurarWidgetsPanel3(cfg)

    valIdiomaUI = idiomaInicial
    valModoArmonia = tonumber(leerValorWidget(widgets.modoArmonia, cfg.modoArmonia ~= nil and tonumber(cfg.modoArmonia) or 0)) or 0
    valPresetCoral = tonumber(leerValorWidget(widgets.presetCoral, cfg.presetCoral ~= nil and tonumber(cfg.presetCoral) or 0)) or 0
    valAntiFaseMs = tonumber(leerValorWidget(widgets.antiFaseMs, cfg.antiFaseMs ~= nil and tonumber(cfg.antiFaseMs) or 0)) or 0
    valAntiFaseCents = tonumber(leerValorWidget(widgets.antiFaseCents, cfg.antiFaseCents ~= nil and tonumber(cfg.antiFaseCents) or 0)) or 0
    valArmoniaIntervalosCustom = tostring(leerValorWidget(widgets.armoniaIntervalosCustom, cfg.armoniaIntervalosCustom ~= nil and tostring(cfg.armoniaIntervalosCustom) or "+3, +7, -5")) or "+3, +7, -5"
    valEnableJustIntonation = leerValorWidget(widgets.enableJustIntonation, cfg.enableJustIntonation == nil and true or (cfg.enableJustIntonation == true))
    valEscalaMelodica = widgets.escalaMelodica
    valTonica = widgets.tonica
    valAutoDetectKey = widgets.autoDetectKey

    local tr = I18N_DATA[valIdiomaUI] or I18N_DATA[0]
    local rows = {
        { type = "Label", text = tr.vistaSeccionChoices[3] or "Vocal Harmonies & Just Intonation" },
        {
            type = "Container",
            columns = {
        ...
        },
        {
            type = "Container",
            columns = {
                { type = "Label", text = tr.modoArmoniaLabel or "Modo Armonía" },
                { type = "ComboBox", choices = tr.modoArmoniaChoices, value = widgets.modoArmonia }
            }
        },
        {
            type = "Container",
            columns = {
                ...
                { type = "ComboBox", choices = tr.presetCoralChoices, value = widgets.presetCoral }
            }
        },
        {
            type = "Container",
            columns = {
                { type = "Label", text = tr.antiFaseMsLabel or "Anti-Fase (ms)" },
                { type = "Slider", text = tr.antiFaseMsLabel or "Anti-Fase (ms)", minValue = 0, maxValue = 50, interval = 1, value = widgets.antiFaseMs }
            }
        },
        {
            type = "Container",
            columns = {
                { type = "Label", text = tr.antiFaseCentsLabel or "Anti-Fase (cents)" },
                { type = "Slider", text = tr.antiFaseCentsLabel or "Anti-Fase (cents)", minValue = 0, maxValue = 30, interval = 1, value = widgets.antiFaseCents }
            }
        },
        {
            type = "Container",
            columns = {
                { type = "Label", text = tr.armoniaIntervalosCustomLabel or "Intervalos Custom" },
                { type = "TextBox", value = widgets.armoniaIntervalosCustom, width = 1.0 }
            }
        },
        {
            type = "Container",
            columns = {
                ...
                { type = "CheckBox", text = tr.enableJustIntonation or "Entonación Justa", value = widgets.enableJustIntonation }
            }
        },
        {
            type = "Container",
...
function ejecutarOperacionPrincipal()
    ...
    local armoniaIntervalosCustom = cfg.armoniaIntervalosCustom
